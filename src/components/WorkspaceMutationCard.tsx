                    ...
                    {status === 'pending' ? (
                        ...
                        >
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 bg-white/5 border border-white/10 text-white px-6 py-3 rounded-full text-[13px] font-medium transition-all hover:bg-white/10 active:scale-95"
                            >
                                <X className="w-4 h-4" />
                                Reject
                            </button>
                        ...
                        >
                            {status === 'approved' ? (
                                ...
                                <div className="flex items-center gap-2 text-neutral-400 bg-white/5 border border-white/10 px-4 py-2 rounded-full text-[12px] font-mono font-bold uppercase tracking-widest">
