...
const EditorialArticleCard = React.memo(({ article }: { article: EditorialArticle }) => {
    ...
    return (
        <motion.article 
            ...
            className="flex flex-col min-w-[85%] sm:min-w-[340px] max-w-[340px] snap-center sm:snap-start overflow-hidden rounded-[24px] bg-neutral-900/60 backdrop-blur-md border border-white/[0.05] transition-all duration-300 hover:bg-neutral-900/80 group relative shadow-lg"
        >
                ...
                <div className="h-48 w-full overflow-hidden relative bg-neutral-950 border-b border-white/[0.02]">
                    ...
                    {article.category && (
                        <div className="absolute top-4 left-4 z-20">
                            <span className="px-3 py-1.5 bg-black/70 backdrop-blur-md rounded-[6px] border border-white/[0.1] text-[10px] font-bold text-white uppercase tracking-widest select-none shadow-sm flex items-center gap-2">
