                    ...
                    {sortedIndices.map((idx) => {
                        ...
                        return (
                            <motion.article 
                                ...
                                className={`relative flex flex-col min-w-[85%] sm:min-w-[340px] max-w-[340px] snap-center sm:snap-start overflow-hidden rounded-[16px] backdrop-blur-md transition-colors duration-500 group cursor-grab active:cursor-grabbing
                                    ${isPinned 
                                        ? 'bg-white/[0.04] border border-white/10 shadow-[0_8px_30px_rgba(0,0,0,0.2)]' 
                            ...
                            >
                                ...
                                <div className="p-6 flex flex-col h-full relative z-10">
                                    ...
                                    <div className="flex items-start gap-4 mb-5 pr-8">
                                        {angle.image_url && (
                                            <div className="h-10 w-10 rounded-full overflow-hidden shrink-0 border border-white/[0.05] bg-[#0a0a0a] flex items-center justify-center">
