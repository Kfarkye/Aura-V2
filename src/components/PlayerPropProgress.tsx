...
export function PlayerPropProgress({ data }: PlayerPropProgressProps) {
    ...
    return (
        <div className="bg-[#151517]/40 backdrop-blur-3xl border border-white/[0.06] rounded-[28px] overflow-hidden shadow-[0_12px_40px_rgba(0,0,0,0.15)] p-6 mb-6 select-none animate-in fade-in slide-in-from-bottom-4 duration-700">
                         ...
                         <div key={idx} className="flex flex-col gap-4">
                             <div className="flex justify-between items-center">
                                 <div className="flex items-center gap-3.5">
                                     <div className="w-11 h-11 rounded-full bg-white/[0.02] overflow-hidden border border-white/[0.08] relative">
                                         {prop.headshot ? (
