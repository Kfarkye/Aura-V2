...
export function EmailMimeViewer({ data }: EmailMimeViewerProps) {
  ...
  return (
    <div className="w-full bg-neutral-950 border border-white/[0.05] rounded-[24px] overflow-hidden flex flex-col text-left font-sans mb-8 shadow-2xl">
      ...
      <div className="p-6 border-b border-white/[0.05] bg-neutral-900">
        <div className="flex flex-col md:flex-row justify-between items-start gap-4">
          <div className="space-y-3 min-w-0 flex-1 w-full">
            <div className="flex flex-wrap items-center gap-3 select-none">
              <span className="text-[10px] font-mono text-neutral-500 uppercase tracking-widest border border-white/[0.06] bg-neutral-800 px-2.5 py-1 rounded-full">
                RFC 5322 Payload
              </span>
      ...
      <div className="flex border-b border-white/[0.05] px-6 overflow-x-auto [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden select-none bg-neutral-900">
        {[
            ...
            <button
              ...
              className={`relative px-4 py-3 text-[11px] font-mono uppercase tracking-widest whitespace-nowrap transition-colors outline-none border-b-2 ${
                active 
                  ...
                  : 'text-neutral-500 border-transparent hover:text-neutral-300 hover:border-white/[0.08]'
              }`}
            >
              {tab.label}
            </button>
      ...
      <div className="flex-1 min-h-[400px] relative">
            ...
            <div className="md:col-span-8 p-6 overflow-y-auto max-h-[500px] bg-neutral-900">
              {selectedPart ? (
                <div className="space-y-8">
                  ...
                  <div className="grid grid-cols-2 gap-6 font-mono text-[12px] bg-neutral-950 p-4 border border-white/[0.06] rounded-lg select-none">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-neutral-950 border border-white/[0.06] rounded-lg p-4 max-h-[200px] overflow-y-auto text-[11px] text-neutral-400 font-mono whitespace-pre-wrap leading-relaxed select-text">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-neutral-950 border border-white/[0.06] rounded-lg p-4 text-[11px] font-mono leading-relaxed break-all select-text">
        ...
        {activeTab === 'headers' && (
          <div className="flex flex-col h-[500px]">
            <div className="p-4 border-b border-white/[0.05] bg-neutral-900">
              <div className="flex items-center gap-3 bg-neutral-950 border border-white/[0.06] rounded-lg px-3 py-2 w-full max-w-sm focus-within:border-white/[0.15] transition-colors">
            ...
            <div className="flex-1 overflow-x-auto bg-neutral-950">
              <table className="w-full font-mono text-[12px] border-collapse tabular-nums lining-nums text-left">
                <thead className="bg-neutral-900 text-neutral-500 uppercase tracking-widest text-[9px] border-b border-white/[0.05] select-none sticky top-0 z-10">
                  <tr>
                    ...
                    filteredHeaders.map((header) => (
                      <tr key={header.name} className="hover:bg-white/[0.03] transition-colors group">
                        ...
                        <td className="px-5 py-3 text-right align-top select-none">
                          <span className="inline-block px-2 py-0.5 rounded-full uppercase tracking-widest text-[9px] text-neutral-500 border border-white/[0.06] bg-neutral-900">
                            {header.category}
                          </span>
                        </td>
        ...
        {activeTab === 'auth' && (
          <div className="p-6 md:p-8 bg-neutral-950 h-full">
            <div className="mb-6 flex items-center justify-between pb-4 border-b border-white/[0.05] select-none">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 font-mono text-[12px] mb-8">
              ...
              {/* SPF */}
              <div className="flex flex-col gap-3 p-4 bg-neutral-900 border border-white/[0.06] rounded-lg shadow-sm">
            ...
            <div className="p-4 bg-neutral-900 border border-white/[0.06] rounded-lg flex items-center justify-between select-none shadow-sm">
