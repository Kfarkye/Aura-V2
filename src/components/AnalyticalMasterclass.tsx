...
const LiveOrderFlow = React.memo(({ consensus }: { consensus: ConsensusData }) => {
  ...
  return (
    <div className="my-14" role="region">
      <div className="border-b border-white/[0.06] pb-4 mb-6 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div>
        ...
        {consensus.splits.map((split, idx) => {
          ...
          return (
            <motion.div
              ...
              className="rounded-[16px] p-6 bg-[#050505] border border-white/[0.06] flex flex-col justify-between"
            >
              <div>
