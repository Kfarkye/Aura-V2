...
export function YoutubeMediaCard({ data, telemetrySink }: YoutubeMediaCardProps) {
    ...
    if (videos.length === 0 || !activeVideo) {
        return (
            <div className="w-full relative z-10 mb-8 mt-4 font-sans text-left bg-black border border-white/[0.06] rounded-[24px] p-8 text-center shadow-2xl flex flex-col items-center justify-center min-h-[250px]">
    ...
    return (
        <div className="w-full relative z-10 mb-8 mt-4 font-sans text-left animate-in fade-in duration-700 ease-[0.16,1,0.3,1]">
            <div className="bg-[#000000] rounded-[24px] overflow-hidden border border-white/[0.06] shadow-[0_24px_50px_rgba(0,0,0,0.6)]">
                
                {/* Structural Header */}
                <div className="px-6 py-4 border-b border-white/[0.06] bg-neutral-950 flex items-center justify-between select-none">
                ...
                <div className="w-full aspect-[16/9] relative bg-black overflow-hidden group border-b border-white/[0.06]">
                        ...
                        {!isPlaying ? (
                            ...
                            >
                                ...
                                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                                    <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-black/50 backdrop-blur-xl border border-white/10 flex items-center justify-center shadow-[0_12px_40px_rgba(0,0,0,0.6)] group-hover:bg-white/10 group-hover:border-white/20 group-hover:scale-105 transition-all duration-500 ease-[0.16,1,0.3,1] group-active:scale-95">
                                ...
                                {activeVideo.duration && (
                                    <div className="absolute bottom-4 right-4 bg-black/85 backdrop-blur-md px-2.5 py-1 rounded-[6px] border border-white/10 pointer-events-none">
                ...
                <div className="px-6 py-6 flex flex-col md:flex-row md:items-start justify-between gap-4 bg-[#000000]">
                    ...
                    <div className="flex items-center gap-2 shrink-0 self-end md:self-start">
                        {videos.length > 1 && (
                            <div className="flex items-center bg-white/[0.03] border border-white/[0.06] rounded-[8px] p-0.5">
                                <button 
                                    onClick={handlePrev}
                        ...
                        <button 
                            ...
                            className={`flex items-center gap-2 px-3.5 py-2 rounded-[8px] border font-mono text-[10px] uppercase tracking-wider font-semibold transition-all duration-300 outline-none focus-visible:ring-1 focus-visible:ring-white/20 ${
                                copied 
                                    ...
                                    : 'bg-white/[0.03] border-white/[0.06] text-neutral-300 hover:bg-white/[0.08] hover:text-white'
                            }`}
                        ...
                        >
                            {videos.map((video, idx) => {
                                ...
                                return (
                                    ...
                                    >
                                        {/* Queue Thumbnail */}
                                        <div className="w-[120px] sm:w-[140px] aspect-video bg-black rounded-[10px] overflow-hidden relative shrink-0 border border-white/[0.06]">
                                            <SafeThumbnail 
                                                src={queueThumbnail} 
                                                alt={video.title} 
                                            ...
                                            />
                                            {video.duration && (
                                                <div className="absolute bottom-1.5 right-1.5 bg-black/85 backdrop-blur-md text-white/90 text-[9px] font-mono px-1.5 py-0.5 rounded-[4px] font-medium tabular-nums lining-nums border border-white/10 pointer-events-none">
                                                    {video.duration}
                                                </div>
                                            )}
                                            {isActive && isPlaying && (
